...
export class PanelRenderer {
    ...
    static createPanel(): {
        ...
        dropdownButton.className = 'icon-button dropdown-button';
        ...
        themeToggleButton.className = 'icon-button theme-toggle';
        ...
        newEddyButton.className = 'icon-button icon-button--create';
        ...
        closeButton.className = 'icon-button icon-button--close';
        ...
        headerRow1.appendChild(closeButton);
